...
import be.isl.ue.ui.util.PaginationHelper;
 ...
 * @author Gael
 */
@Named(value = "capacityController")
@SessionScoped
public class CapacityController implements Serializable{
    ...
    @EJB
    private be.isl.ue.business.CapacityFacade ejbFacade;
    ...
    public static class CapacityControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Capacity) {
                Capacity c = (Capacity) object;
                return getStringKey(c.getCapacityId());
            } else {
